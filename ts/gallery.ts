class ImageSlider {
    private imageElements: ImageSliderElement[] = [
        ...
        new ImageSliderElement("img/gallery/images.png", "Super Mario Bros", "Mario Bros is the most famous Jump and Run game. In this game you control the main-character Mario, who is crossing many levels. Every level is differently and has a goal. </a>"),
